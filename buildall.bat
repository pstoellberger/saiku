...
call git pull
call mvn clean package install:install-file -Dfile=target/saiku-ui-3.0-PSTOELLBERGER-SNAPSHOT.war  -DgroupId=org.saiku -DartifactId=saiku-ui -Dversion=3.0-PSTOELLBERGER-SNAPSHOT -Dpackaging=war
