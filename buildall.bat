...
call git pull
call mvn clean package install:install-file -Dfile=target/saiku-ui-2.7-SNAPSHOT.war  -DgroupId=org.saiku -DartifactId=saiku-ui -Dversion=2.7-SNAPSHOT -Dpackaging=war
